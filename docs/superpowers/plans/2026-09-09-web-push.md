...
| `supabase/migrations/0010_push.sql` | pg_net, `app.settings`, `push_subscriptions`, uid 인자 권한 함수, `app.notification_view`, `get_push_payload`, `save_push_subscription`, 웹훅 트리거 |
...
**Files:**
- Create: `supabase/migrations/0010_push.sql`
...
```bash
git add supabase/migrations/0010_push.sql supabase/seed.sql src/lib/db/types.ts tests/integration/push.test.ts
